...
export const POLICY_OWNERS_PROGRAM_ADDRESS =
  'AR4DTuENTQptMJETG89NNzLJkFPwPWi3jSDJaUmf8CXW' as Address<'AR4DTuENTQptMJETG89NNzLJkFPwPWi3jSDJaUmf8CXW'>;
...
export function identifyPolicyOwnersInstruction(
  ...
  if (
    ...
    return PolicyOwnersInstruction.ValidateCreation;
  }
  throw new Error(
...
export type ParsedPolicyOwnersInstruction<
  TProgram extends string = 'AR4DTuENTQptMJETG89NNzLJkFPwPWi3jSDJaUmf8CXW',
> =
  | ({
  ...
  | ({
      instructionType: PolicyOwnersInstruction.ValidateCreation;
