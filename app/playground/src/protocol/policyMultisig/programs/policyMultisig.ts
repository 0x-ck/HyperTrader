...
export const POLICY_MULTISIG_PROGRAM_ADDRESS =
  '5EJiFNzQ8JqSHThnKFSTZqLtALFh4NkHMpk2SyDcWjyw' as Address<'5EJiFNzQ8JqSHThnKFSTZqLtALFh4NkHMpk2SyDcWjyw'>;
...
export function identifyPolicyMultisigInstruction(
  ...
  if (
    ...
    return PolicyMultisigInstruction.ValidateCreation;
  }
  throw new Error(
...
export type ParsedPolicyMultisigInstruction<
  TProgram extends string = '5EJiFNzQ8JqSHThnKFSTZqLtALFh4NkHMpk2SyDcWjyw',
> =
  | ({
  ...
  | ({
      instructionType: PolicyMultisigInstruction.ValidateCreation;
