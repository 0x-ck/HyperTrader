...
export const POLICY_LIMIT_TRANSFER_PROGRAM_ADDRESS =
  '7pM2BCBvrkzdJREg7CidtwW1CbU9GN9VJ3qNDZS1wmBq' as Address<'7pM2BCBvrkzdJREg7CidtwW1CbU9GN9VJ3qNDZS1wmBq'>;
...
export function identifyPolicyLimitTransferInstruction(
  ...
  if (
    ...
    return PolicyLimitTransferInstruction.ValidateCreation;
  }
  throw new Error(
...
export type ParsedPolicyLimitTransferInstruction<
  TProgram extends string = '7pM2BCBvrkzdJREg7CidtwW1CbU9GN9VJ3qNDZS1wmBq',
> =
  | ({
  ...
  | ({
      instructionType: PolicyLimitTransferInstruction.ValidateCreation;
