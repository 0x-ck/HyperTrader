...
export const POLICY_CHALLENGES_PROGRAM_ADDRESS =
  '6pPrHzNFZtEUzvUEhikti2QRaeAVXwJqQjWysJpDqgib' as Address<'6pPrHzNFZtEUzvUEhikti2QRaeAVXwJqQjWysJpDqgib'>;
...
export function identifyPolicyChallengesInstruction(
  ...
  if (
    ...
    return PolicyChallengesInstruction.ValidateCreation;
  }
  throw new Error(
...
export type ParsedPolicyChallengesInstruction<
  TProgram extends string = '6pPrHzNFZtEUzvUEhikti2QRaeAVXwJqQjWysJpDqgib',
> =
  | ({
  ...
  | ({
      instructionType: PolicyChallengesInstruction.ValidateCreation;
