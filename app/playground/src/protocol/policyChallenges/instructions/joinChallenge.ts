...
> = {
  ...
  stageId: JoinChallengeInstructionDataArgs['stageId'];
  stageSequence: JoinChallengeInstructionDataArgs['stageSequence'];
  profitTarget: JoinChallengeInstructionDataArgs['profitTarget'];
  tradingDays: JoinChallengeInstructionDataArgs['tradingDays'];
  maximumLoss: JoinChallengeInstructionDataArgs['maximumLoss'];
  dailyDrawdown: JoinChallengeInstructionDataArgs['dailyDrawdown'];
  status: JoinChallengeInstructionDataArgs['status'];
  payout: JoinChallengeInstructionDataArgs['payout'];
  createdAt: JoinChallengeInstructionDataArgs['createdAt'];
};
