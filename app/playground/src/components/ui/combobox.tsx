          ...
          >
            ...
            {query && (
              <CommandEmpty
                ...
                className="flex cursor-pointer items-left justify-center gap-1 italic py-2"
              >
                <p className="block flex-shrink-0 text-sm">Create: </p>
                <p className="block max-w-48 truncate font-semibold text-primary flex-grow flex-shrink text-sm">
                  {query}
                </p>
              </CommandEmpty>
            )}
